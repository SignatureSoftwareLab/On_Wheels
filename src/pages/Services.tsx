...
//                             {/* toggle button for service and category search */}
//                             <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center space-x-2">
//                                 <Button
//                                     type="button"
//                                     variant={searchMode === 'services' ? "outline" : "secondary"}
//                                     size="sm"
...
//                                 <Button
//                                     type="button"
//                                     variant={searchMode === 'categories' ? "outline" : "secondary"}
//                                     size="sm"
...
//                             {/* Show search results info for categories */}
//                             {searchMode === 'categories' && searchQuery && (
//                                 <div className="mb-3">
...
//                     {!loading && !infoMessage && (
//                         <>
//                             {/* Show search results info for services */}
//                             {searchMode === 'services' && searchQuery && (
//                                 <div className="mb-3">
//                                     <p className="text-sm text-muted-foreground">
...
//                                     {filteredServices.length}
//                                 </span> services
//                                 {activeFilter && <span> in <span className="font-semibold text-foreground">{activeFilter}</span></span>}
//                             </p>
